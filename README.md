...
Whispy requires at least one API key to function.
...
### "Whispy" can't be opened because Apple cannot check it for malicious software
...
2. Try restarting Whispy after granting permissions
...
rm -rf ~/Library/Application\ Support/Whispy
```
